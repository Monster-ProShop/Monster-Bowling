const CACHE='brackets-20260923';
const CORE=['/','/index.html','/app.js?v=20260923-sessions','/portal.js?v=20260923-sessions','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
