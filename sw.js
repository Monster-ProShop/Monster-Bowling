const CACHE='brackets-20260925-separate-session-actions';
const CORE=['/','/index.html','/app.js?v=20260925-separate-session-actions','/portal.js?v=20260925-separate-session-actions','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
