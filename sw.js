const CACHE='brackets-20260924-superadmin-access';
const CORE=['/','/index.html','/app.js?v=20260924-superadmin-access','/portal.js?v=20260924-superadmin-access','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
