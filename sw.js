const CACHE='brackets-20260924-user-balance';
const CORE=['/','/index.html','/app.js?v=20260924-user-balance','/portal.js?v=20260924-user-balance','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
