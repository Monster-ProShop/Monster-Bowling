const CACHE='brackets-20260924-superadmin';
const CORE=['/','/index.html','/app.js?v=20260924-superadmin','/portal.js?v=20260924-superadmin','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
