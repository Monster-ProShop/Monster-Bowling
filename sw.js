const CACHE='brackets-20260924-simple-login';
const CORE=['/','/index.html','/app.js?v=20260924-simple-login','/portal.js?v=20260924-simple-login','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
