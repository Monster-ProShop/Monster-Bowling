const CACHE='brackets-20260925-spanish-terms';
const CORE=['/','/index.html','/app.js?v=20260925-spanish-terms','/portal.js?v=20260925-spanish-terms','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
