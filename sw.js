const CACHE='brackets-20260924-config-save';
const CORE=['/','/index.html','/app.js?v=20260924-config-save','/portal.js?v=20260924-config-save','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
