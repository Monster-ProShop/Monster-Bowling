const CACHE='brackets-20260924-bowler-brackets';
const CORE=['/','/index.html','/app.js?v=20260924-bowler-brackets','/portal.js?v=20260924-bowler-brackets','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
