const CACHE='brackets-20260924-payments';
const CORE=['/','/index.html','/app.js?v=20260924-payments','/portal.js?v=20260924-payments','/portal-config.js','/manifest.webmanifest','/assets/brackets-logo.png?v=20260922','/assets/app-icon.svg'];
